...
namespace Netsphere
{
    ...
    public class GameSettings
    {
        ...
        [JsonProperty("exp_rates_warfare")]
        public ExperienceRates WarfareExpRates { get; set; }

        [JsonProperty("exp_rates_siege")]
        public ExperienceRates SiegeExpRates { get; set; }

        [JsonProperty("exp_rates_arena")]
        public ExperienceRates ArenaExpRates { get; set; }
        ...
        public GameSettings()
        {
            ...
            ArenaExpRates = new ExperienceRates();
            SiegeExpRates = new ExperienceRates();
            WarfareExpRates = new ExperienceRates();
        }
    }
