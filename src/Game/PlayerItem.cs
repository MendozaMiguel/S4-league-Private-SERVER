...
namespace Netsphere
{
    internal class PlayerItem
    {
        ...
        public ItemPriceType PriceType { get; } = (ItemPriceType)3;
        public ItemPeriodType PeriodType { get; } = (ItemPeriodType)1;
        public ushort Period { get; } = 1;
        public byte Color { get; } = 0;
        public uint Effect { get; }
        public DateTimeOffset PurchaseDate { get; } = DateTimeOffset.Now;
